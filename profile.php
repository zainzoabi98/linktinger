...
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <div class="grid-container">
        ...
        <div class="main">
            <div class=''>
                <div class=''>
                    <!--TWEET WRAPPER-->
                    <p class="page_title mb-0"><i class="fa fa-arrow-left mr-4" style="color:#271f81;"></i><?php echo $profileData->username; ?></p>
    ...
    <h6 class="mr-3 ml-1" style="font-weight: 700;">
        <?php echo $profileData->following; ?>
        <a href="<?php echo BASE_URL; ?>following.php?username=<?php echo urlencode($profileData->username); ?>" style="color:rgb(91, 112, 131);">
            Following
        </a>
    </h6>
    <h6 class="mr-3" style="font-weight: 700;">
        <?php echo $profileData->followers; ?>
        <a href="<?php echo BASE_URL; ?>followers.php?username=<?php echo urlencode($profileData->username); ?>" style="color:rgb(91, 112, 131);">
            Followers
        </a>
    </h6>
    <h6 style="font-weight: 700;">
        <?php echo $getFromT->countTweets($profileId); ?>
        <a href="<?php echo BASE_URL; ?>profile.php?username=<?php echo urlencode($profileData->username); ?>" style="color:rgb(91, 112, 131);">
            Postly
        </a>
    </h6>
</div>
                    ...
                    <!--Tweet SHOW WRAPPER-->
                    <div class='tweets'>
                    <?php $getFromT->tweets2($profileId, 100, true); ?>
                    </div>
                    <!--TWEETS SHOW WRAPPER-->
