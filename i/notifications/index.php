...
<head>
    <title>Notifications - linktinger</title>
    <meta charset="UTF-8" />
                        ...
                        <div class="notification-wrapper">
                            <div class="notification-inner">
                                <div class="notification-header">
                                    ...
                                    <a href="<?php echo BASE_URL . 'profile.php?username=' . urlencode($data->username); ?>" class="notifi-name">
    <?php echo htmlspecialchars($data->screenName); ?>
</a> 
<span> Followed you - <span><?php echo $getFromU->timeAgo($data->time); ?></span></span>
