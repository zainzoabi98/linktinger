...
<div class="sidebar">
    <ul style="list-style:none;">
        <li><img src="assets/images/Postly.png" alt="Logo" style="width: 200px; height: 200px;"></li>

        <li class="active_menu"><a href='<?php echo BASE_URL; ?>home.php'><i class="fa fa-home" style="color:#271f81;"></i><span style="color:#271f81;">Home</span></a></li>
        ...
        <?php if ($getFromU->loggedIn() === true) { ?>
           ...
           <!-- <li><a href='<?php echo BASE_URL; ?>groups.php'><i class="fa fa-users"></i><span>Groups</span></a></li> 
            <li><a href='<?php echo BASE_URL; ?>jobs.php'><i class="fa fa-briefcase"></i><span>Jobs</span></a></li> 
            -->
            ...
            <li style="padding:10px 40px;"><button class="sidebar_tweet button addTweetBtn" style="outline:none;">Postly</button></li>
        <?php } ?>
                ...
                <li class="media-inner">
                    <a href="<?php echo BASE_URL.$user->username; ?>">
                        ...
                        <div class="media-body">
                            <h5 class="mt-0 mb-1">
                            <a href="<?php echo BASE_URL; ?>profile.php?username=<?php echo $user->username; ?>"><span><?php echo '<b>' . $user->screenName . '</b>'; ?></span></a>
                            </h5>
