		...
		if(!empty($_POST['screenName'])){
			...
			if(strlen($screenName) > 20){
				...
				$error = "Country name is too long";
				 ...
				 header('Location: '.BASE_URL.'profile.php?username='.$user->username);
			}
		}else{
...
<head>
    <title>Edit Profile - linktinger</title>
    <meta charset="UTF-8" />
...
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <div class="grid-container">
        ...
        <div class="main">
            ...
            <p class="page_title mb-0"><i class="fa fa-pencil-square-o mr-4" style="color:#271f81;"></i>Edit Profile</p>
